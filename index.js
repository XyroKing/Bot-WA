...
async function startAdrian() {
    ...
    const conn = connConnect({
        ...
        browser: ['Koneko-MD','Safari','1.0.0'],
        ...
        try {
            ...
            for (let num of participants) {
               ...
               if (anu.action == 'add') {
                 ...
                 conn.sendMessage(anu.id, { audio: fs.readFileSync('./mp3/welcome.mp3'), mimetype: 'audio/mp4', ptt: true, fileLength: 88738})
     ...
     text: a, 
      contextInfo: {
         ...
         renderLargerThumbnail: true
                    ...
                    conn.sendMessage(anu.id, { audio: fs.readFileSync('./mp3/leave.mp3'), mimetype: 'audio/mp4', ptt: true, fileLength: 88738})
      conn.sendMessage(anu.id, {
     text: a, 
      contextInfo: {
         externalAdReply: {
...
try{
		...
		} else if (connection === "open") { conn.sendMessage(antiyt + "@s.whatsapp.net", { text: `*Bot Started!*\n\n\n*_Don't forget to subscribe, bro :3_*\n\n*YouTube:*\nhttps://youtube.com/@qyuunee` }); }
